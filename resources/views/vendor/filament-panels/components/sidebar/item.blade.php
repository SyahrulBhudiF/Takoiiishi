...
>
    ...
    >
        ...
        <span
            @if ($sidebarCollapsible && (! $subNavigation))
                x-show="$store.sidebar.isOpen"
                x-transition:enter="sidebar-label-enter"
                x-transition:enter-start="sidebar-label-enter-start"
                x-transition:enter-end="sidebar-label-enter-end"
                x-transition:leave="sidebar-label-leave"
                x-transition:leave-start="sidebar-label-leave-start"
                x-transition:leave-end="sidebar-label-leave-end"
            @endif
